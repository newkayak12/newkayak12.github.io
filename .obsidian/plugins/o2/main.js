...
var require_jsbi_umd = __commonJS({
  "node_modules/jsbi/dist/jsbi-umd.js"(exports, module2) {
    (function(e2, t2) {
      ...
      function n2(e3, t3) {
        for (var _3, n3 = 0; n3 < t3.length; n3++) _3 = t3[n3], _3.enumerable = _3.enumerable || false, _3.configurable = true, "value" in _3 && (_3.writable = true), Object.defineProperty(e3, _3.key, _3);
      }
      ...
      function c2(e3) {
        ...
        return function() {
          ...
          } else i3 = _3.apply(this, arguments);
          return m2(this, i3);
        };
      }
      function v2(e3, t3) {
      ...
      function D2(e3, t3) {
        if (e3) {
          if ("string" == typeof e3) return p2(e3, t3);
      ...
      function p2(e3, t3) {
        ...
        for (var _3 = 0, n3 = Array(t3); _3 < t3; _3++) n3[_3] = e3[_3];
        return n3;
      }
      function k2() {
      ...
      var S2 = function(e3) {
        ...
        function a3(e4, t4) {
          var i3;
          if (_2(this, a3), i3 = u3.call(this, e4), i3.sign = t4, Object.setPrototypeOf(b2(i3), a3.prototype), e4 > a3.__kMaxLength) throw new RangeError("Maximum BigInt size exceeded");
          return i3;
        }
        g2(a3, e3);
        var u3 = c2(a3);
        return l2(a3, [{ key: "toDebugString", value: function() {
          ...
          if (2 > e4 || 36 < e4) throw new RangeError("toString() radix argument must be between 2 and 36");
          ...
          for (var e4 = new a3(this.length, this.sign), t4 = 0; t4 < this.length; t4++) e4[t4] = this[t4];
          return e4;
        } }, { key: "__trim", value: function() {
          for (var e4 = this.length, t4 = this[e4 - 1]; 0 === t4; ) e4--, t4 = this[e4 - 1], this.pop();
          return 0 === e4 && (this.sign = false), this;
        } }, { key: "__initializeDigits", value: function() {
          for (var e4 = 0; e4 < this.length; e4++) this[e4] = 0;
          ...
          if (0 !== g3 || 0 !== o3) throw new Error("implementation bug");
        } }, { key: "__inplaceAdd", value: function(e4, t4, _3) {
          for (var n4, l3 = 0, g3 = 0; g3 < _3; g3++) n4 = this.__halfDigit(t4 + g3) + e4.__halfDigit(g3) + l3, l3 = n4 >>> 15, this.__setHalfDigit(t4 + g3, 32767 & n4);
          return l3;
          ...
          if (1 & t4) {
            ...
            if (t4 + o3 + 1 >= this.length) throw new RangeError("out of bounds");
          ...
          if (0 !== e4) {
            for (var t4, _3 = this.__digit(0) >>> e4, n4 = this.length - 1, l3 = 0; l3 < n4; l3++) t4 = this.__digit(l3 + 1), this.__setDigit(l3, 1073741823 & t4 << 30 - e4 | _3), _3 = t4 >>> e4;
          ...
          if ("number" == typeof e4) {
            if (0 === e4) return a3.__zero();
            if (a3.__isOneDigitInt(e4)) return 0 > e4 ? a3.__oneDigit(-e4, true) : a3.__oneDigit(e4, false);
            if (!t4(e4) || o2(e4) !== e4) throw new RangeError("The number " + e4 + " cannot be converted to BigInt because it is not an integer");
            return a3.__fromDouble(e4);
          }
          if ("string" == typeof e4) {
            var _3 = a3.__fromString(e4);
            if (null === _3) throw new SyntaxError("Cannot convert " + e4 + " to a BigInt");
            return _3;
          }
          if ("boolean" == typeof e4) return true === e4 ? a3.__oneDigit(1, false) : a3.__zero();
          if ("object" === i2(e4)) {
            if (e4.constructor === a3) return e4;
          ...
          for (0 < d3 && 0 < u4 && (u4--, o3 = e4.__digit(u4), r3 |= o3 >>> 30 - d3, h3 = o3 << d3 + 2, b3 = d3 + 2); 0 < b3 && 0 < u4; ) u4--, o3 = e4.__digit(u4), h3 |= 30 <= b3 ? o3 << b3 - 30 : o3 >>> 30 - b3, b3 -= 30;
          var m3 = a3.__decideRounding(e4, b3, u4, o3);
          if ((1 === m3 || 0 === m3 && 1 == (1 & h3)) && (h3 = h3 + 1 >>> 0, 0 === h3 && (r3++, 0 != r3 >>> 20 && (r3 = 0, g3++, 1023 < g3)))) return e4.sign ? -Infinity : 1 / 0;
          ...
          if (0 === t4.length) return a3.__oneDigit(1, false);
          if (0 === e4.length) return e4;
          if (1 === e4.length && 1 === e4.__digit(0)) return e4.sign && 0 == (1 & t4.__digit(0)) ? a3.unaryMinus(e4) : e4;
          if (1 < t4.length) throw new RangeError("BigInt too big");
          var i3 = t4.__unsignedDigit(0);
          if (1 === i3) return e4;
          if (i3 >= a3.__kMaxLengthBits) throw new RangeError("BigInt too big");
          ...
          var o3 = null, u4 = e4;
          for (0 != (1 & i3) && (o3 = e4), i3 >>= 1; 0 !== i3; i3 >>= 1) u4 = a3.multiply(u4, u4), 0 != (1 & i3) && (null === o3 ? o3 = u4 : o3 = a3.multiply(o3, u4));
          return o3;
          ...
          for (var _3 = 0; _3 < e4.length; _3++) if (e4.__digit(_3) !== t4.__digit(_3)) return false;
          return true;
        } }, { key: "notEqual", value: function(e4, t4) {
          return !a3.equal(e4, t4);
        } }, { key: "bitwiseAnd", value: function(e4, t4) {
          if (!e4.sign && !t4.sign) return a3.__absoluteAnd(e4, t4).__trim();
          if (e4.sign && t4.sign) {
          ...
          if (!e4.sign && !t4.sign) return a3.__absoluteXor(e4, t4).__trim();
          if (e4.sign && t4.sign) {
          ...
          if (!e4.sign && !t4.sign) return a3.__absoluteOr(e4, t4).__trim();
          if (e4.sign && t4.sign) {
          ...
          if (0 === t4.length) return t4;
          if (e4 = o2(e4), 0 > e4) throw new RangeError("Invalid value: not (convertible to) a safe integer");
          if (0 === e4) return a3.__zero();
          if (e4 >= a3.__kMaxLengthBits) return t4;
          var _3 = 0 | (e4 + 29) / 30;
          if (t4.length < _3) return t4;
          var l3 = t4.__unsignedDigit(_3 - 1), g3 = 1 << (e4 - 1) % 30;
          if (t4.length === _3 && l3 < g3) return t4;
          if (!((l3 & g3) === g3)) return a3.__truncateToNBits(e4, t4);
          if (!t4.sign) return a3.__truncateAndSubFromPowerOfTwo(e4, t4, true);
          if (0 == (l3 & g3 - 1)) {
            for (var u4 = _3 - 2; 0 <= u4; u4--) if (0 !== t4.__digit(u4)) return a3.__truncateAndSubFromPowerOfTwo(e4, t4, false);
          ...
          if (0 === e4) return a3.__zero();
          if (t4.sign) {
            if (e4 > a3.__kMaxLengthBits) throw new RangeError("BigInt too big");
            return a3.__truncateAndSubFromPowerOfTwo(e4, t4, false);
          }
          if (e4 >= a3.__kMaxLengthBits) return t4;
          var i3 = 0 | (e4 + 29) / 30;
          if (t4.length < i3) return t4;
          var _3 = e4 % 30;
          if (t4.length == i3) {
            if (0 === _3) return t4;
            var l3 = t4.__digit(i3 - 1);
            if (0 == l3 >>> _3) return t4;
          }
          return a3.__truncateToNBits(e4, t4);
        } }, { key: "ADD", value: function(e4, t4) {
          if (e4 = a3.__toPrimitive(e4), t4 = a3.__toPrimitive(t4), "string" == typeof e4) return "string" != typeof t4 && (t4 = t4.toString()), e4 + t4;
          if ("string" == typeof t4) return e4.toString() + t4;
          if (e4 = a3.__toNumeric(e4), t4 = a3.__toNumeric(t4), a3.__isBigInt(e4) && a3.__isBigInt(t4)) return a3.add(e4, t4);
          ...
          for (; ; ) {
            if (a3.__isBigInt(e4)) return a3.__isBigInt(t4) ? a3.equal(e4, t4) : a3.EQ(t4, e4);
            if ("number" == typeof e4) {
              if (a3.__isBigInt(t4)) return a3.__equalToNumber(t4, e4);
              if ("object" !== i2(t4)) return e4 == t4;
              t4 = a3.__toPrimitive(t4);
            } else if ("string" == typeof e4) {
              if (a3.__isBigInt(t4)) return e4 = a3.__fromString(e4), null !== e4 && a3.equal(e4, t4);
              if ("object" !== i2(t4)) return e4 == t4;
              t4 = a3.__toPrimitive(t4);
              ...
              if (a3.__isBigInt(t4)) return false;
              if ("object" !== i2(t4)) return e4 == t4;
              t4 = a3.__toPrimitive(t4);
            } else if ("object" === i2(e4)) {
              if ("object" === i2(t4) && t4.constructor !== a3) return e4 == t4;
          ...
          var l3 = 1 << n4;
          if (0 == (_3 & l3)) return -1;
          if (l3 -= 1, 0 != (_3 & l3)) return 1;
          for (; 0 < i3; ) if (i3--, 0 !== e4.__digit(i3)) return 1;
          return 0;
          ...
          } else if (s3 === u4) r3 = 32, t4 = g3, g3 = o3, o3 = 0;
          else {
            var h3 = s3 - u4;
            r3 = 32 - h3, t4 = g3 << h3 | o3 >>> 32 - h3, g3 = o3 << h3, o3 = 0;
          }
          l3.__setDigit(n4 - 1, t4);
          for (var b3 = n4 - 2; 0 <= b3; b3--) 0 < r3 ? (r3 -= 30, t4 = g3 >>> 2, g3 = g3 << 30 | o3 >>> 2, o3 <<= 30) : t4 = 0, l3.__setDigit(b3, t4);
          return l3.__trim();
          ...
          if (0 === t4) {
            if (t4 = 10, 48 === l3) {
              ...
              if (l3 = e4.charCodeAt(n4), 88 === l3 || 120 === l3) {
                if (t4 = 16, ++n4 === _3) return null;
                l3 = e4.charCodeAt(n4);
              } else if (79 === l3 || 111 === l3) {
                if (t4 = 8, ++n4 === _3) return null;
                l3 = e4.charCodeAt(n4);
              } else if (66 === l3 || 98 === l3) {
                if (t4 = 2, ++n4 === _3) return null;
                l3 = e4.charCodeAt(n4);
              }
            }
          } else if (16 === t4 && 48 === l3) {
          ...
          if (0 == (t4 & t4 - 1)) {
            ...
            do {
              for (var f3, D3 = 0, p3 = 0; ; ) {
                if (f3 = void 0, l3 - 48 >>> 0 < h3) f3 = l3 - 48;
                else if ((32 | l3) - 97 >>> 0 < b3) f3 = (32 | l3) - 87;
                else {
                  y3 = true;
                  break;
                }
                ...
                if (l3 = e4.charCodeAt(n4), 30 < p3 + o3) break;
              }
            ...
            do {
              for (var S3, C2 = 0, I2 = 1; ; ) {
                if (S3 = void 0, l3 - 48 >>> 0 < h3) S3 = l3 - 48;
                else if ((32 | l3) - 97 >>> 0 < b3) S3 = (32 | l3) - 87;
                else {
                  k3 = true;
                  break;
                }
                var A2 = I2 * t4;
                if (1073741823 < A2) break;
          ...
          if (n4 !== _3) {
            if (!a3.__isWhitespace(l3)) return null;
            for (n4++; n4 < _3; n4++) if (l3 = e4.charCodeAt(n4), !a3.__isWhitespace(l3)) return null;
          }
          ...
          if (0 !== l3) {
            if (n4 >= e4.length) throw new Error("implementation bug");
            e4.__setDigit(n4++, l3);
          }
          for (; n4 < e4.length; n4++) e4.__setDigit(n4, 0);
          ...
          if (e4.sign && s3++, 268435456 < s3) throw new Error("string too long");
          for (var r3 = Array(s3), d3 = s3 - 1, h3 = 0, b3 = 0, m3 = 0; m3 < _3 - 1; m3++) {
            var c3 = e4.__digit(m3), v3 = (h3 | c3 << b3) & g3;
            r3[d3--] = a3.__kConversionChars[v3];
            var y3 = l3 - b3;
            for (h3 = c3 >>> y3, b3 = 30 - y3; b3 >= l3; ) r3[d3--] = a3.__kConversionChars[h3 & g3], h3 >>>= l3, b3 -= l3;
          }
          var f3 = (h3 | o3 << b3) & g3;
          for (r3[d3--] = a3.__kConversionChars[f3], h3 = o3 >>> l3 - b3; 0 !== h3; ) r3[d3--] = a3.__kConversionChars[h3 & g3], h3 >>>= l3;
          if (e4.sign && (r3[d3--] = "-"), -1 !== d3) throw new Error("implementation bug");
          return r3.join("");
          ...
          if (1 === b3.length && 32767 >= m3) {
            ...
            for (var c3, v3 = 0, y3 = 2 * e4.length - 1; 0 <= y3; y3--) c3 = v3 << 15 | e4.__halfDigit(y3), r3.__setHalfDigit(y3, 0 | c3 / m3), v3 = 0 | c3 % m3;
            d3 = v3.toString(t4);
          } else {
          ...
          r3.__trim();
          for (var p3 = a3.__toStringGeneric(r3, t4, true); d3.length < h3; ) d3 = "0" + d3;
          ...
          var i3 = e4.sign;
          if (i3 !== t4.sign) return a3.__unequalSign(i3);
          ...
          if (a3.__isOneDigitInt(i3)) {
            ...
            if (_3 !== n4) return a3.__unequalSign(_3);
            if (0 === e4.length) {
              if (n4) throw new Error("implementation bug");
              return 0 === i3 ? 0 : -1;
            }
            if (1 < e4.length) return a3.__absoluteGreater(_3);
          ...
          var i3 = e4.sign;
          if (i3 !== 0 > t4) return a3.__unequalSign(i3);
          ...
          if (2047 == _3) throw new Error("implementation bug: handled elsewhere");
          var n4 = _3 - 1023;
          if (0 > n4) return a3.__absoluteGreater(i3);
          var l3 = e4.length, g3 = e4.__digit(l3 - 1), o3 = a3.__clz30(g3), u4 = 30 * l3 - o3, s3 = n4 + 1;
          if (u4 < s3) return a3.__absoluteLess(i3);
          if (u4 > s3) return a3.__absoluteGreater(i3);
          var r3 = 1048576 | 1048575 & a3.__kBitConversionInts[1], d3 = a3.__kBitConversionInts[0], h3 = 20, b3 = 29 - o3;
          if (b3 !== (0 | (u4 - 1) % 30)) throw new Error("implementation bug");
          var m3, c3 = 0;
          if (b3 < h3) {
            var v3 = h3 - b3;
            c3 = v3 + 32, m3 = r3 >>> v3, r3 = r3 << 32 - v3 | d3 >>> v3, d3 <<= 32 - v3;
          } else if (b3 === h3) c3 = 32, m3 = r3, r3 = d3, d3 = 0;
          else {
            var y3 = b3 - h3;
            c3 = 32 - y3, m3 = r3 << y3 | d3 >>> 32 - y3, r3 = d3 << y3, d3 = 0;
          }
          if (g3 >>>= 0, m3 >>>= 0, g3 > m3) return a3.__absoluteGreater(i3);
          if (g3 < m3) return a3.__absoluteLess(i3);
          for (var f3 = l3 - 2; 0 <= f3; f3--) {
            0 < c3 ? (c3 -= 30, m3 = r3 >>> 2, r3 = r3 << 30 | d3 >>> 2, d3 <<= 30) : m3 = 0;
            var D3 = e4.__unsignedDigit(f3);
            if (D3 > m3) return a3.__absoluteGreater(i3);
            if (D3 < m3) return a3.__absoluteLess(i3);
          }
          if (0 !== r3 || 0 !== d3) {
            if (0 === c3) throw new Error("implementation bug");
          ...
          if (e4 = a3.__toPrimitive(e4), t4 = a3.__toPrimitive(t4), "string" == typeof e4 && "string" == typeof t4) switch (i3) {
            case 0:
              return e4 < t4;
            case 1:
              return e4 <= t4;
          ...
          if (a3.__isBigInt(e4) && "string" == typeof t4) return t4 = a3.__fromString(t4), null !== t4 && a3.__comparisonResultToBool(a3.__compareToBigInt(e4, t4), i3);
          if ("string" == typeof e4 && a3.__isBigInt(t4)) return e4 = a3.__fromString(e4), null !== e4 && a3.__comparisonResultToBool(a3.__compareToBigInt(e4, t4), i3);
          if (e4 = a3.__toNumeric(e4), t4 = a3.__toNumeric(t4), a3.__isBigInt(e4)) {
            if (a3.__isBigInt(t4)) return a3.__comparisonResultToBool(a3.__compareToBigInt(e4, t4), i3);
          ...
          if (a3.__isBigInt(t4)) return a3.__comparisonResultToBool(a3.__compareToNumber(t4, e4), 2 ^ i3);
          if ("number" != typeof t4) throw new Error("implementation bug");
          return 0 === i3 ? e4 < t4 : 1 === i3 ? e4 <= t4 : 2 === i3 ? e4 > t4 : 3 === i3 ? e4 >= t4 : void 0;
        } }, { key: "__absoluteAdd", value: function(e4, t4, _3) {
          if (e4.length < t4.length) return a3.__absoluteAdd(t4, e4, _3);
          if (0 === e4.length) return e4;
          if (0 === t4.length) return e4.sign === _3 ? e4 : a3.unaryMinus(e4);
          var n4 = e4.length;
          (0 === e4.__clzmsd() || t4.length === e4.length && 0 === t4.__clzmsd()) && n4++;
          for (var l3, g3 = new a3(n4, _3), o3 = 0, u4 = 0; u4 < t4.length; u4++) l3 = e4.__digit(u4) + t4.__digit(u4) + o3, o3 = l3 >>> 30, g3.__setDigit(u4, 1073741823 & l3);
          for (; u4 < e4.length; u4++) {
          ...
          if (0 === e4.length) return e4;
          if (0 === t4.length) return e4.sign === _3 ? e4 : a3.unaryMinus(e4);
          for (var n4, l3 = new a3(e4.length, _3), g3 = 0, o3 = 0; o3 < t4.length; o3++) n4 = e4.__digit(o3) - t4.__digit(o3) - g3, g3 = 1 & n4 >>> 30, l3.__setDigit(o3, 1073741823 & n4);
          for (; o3 < e4.length; o3++) {
          ...
          for (var l3, g3 = 1, o3 = 0; o3 < n4; o3++) l3 = e4.__digit(o3) + g3, g3 = l3 >>> 30, _3.__setDigit(o3, 1073741823 & l3);
          return 0 !== g3 && _3.__setDigitGrow(n4, 1), _3;
        } }, { key: "__absoluteSubOne", value: function(e4, t4) {
          var _3 = e4.length;
          t4 = t4 || _3;
          for (var n4, l3 = new a3(t4, false), g3 = 1, o3 = 0; o3 < _3; o3++) n4 = e4.__digit(o3) - g3, g3 = 1 & n4 >>> 30, l3.__setDigit(o3, 1073741823 & n4);
          if (0 !== g3) throw new Error("implementation bug");
          for (var u4 = _3; u4 < t4; u4++) l3.__setDigit(u4, 0);
          return l3;
          ...
          for (var r3 = 0; r3 < g3; r3++) _3.__setDigit(r3, e4.__digit(r3) & t4.__digit(r3));
          for (; r3 < s3; r3++) _3.__setDigit(r3, 0);
          return _3;
          ...
          for (var u4 = 0; u4 < g3; u4++) _3.__setDigit(u4, e4.__digit(u4) & ~t4.__digit(u4));
          for (; u4 < n4; u4++) _3.__setDigit(u4, e4.__digit(u4));
          for (; u4 < o3; u4++) _3.__setDigit(u4, 0);
          return _3;
          ...
          null === _3 ? _3 = new a3(s3, false) : s3 = _3.length;
          for (var r3 = 0; r3 < g3; r3++) _3.__setDigit(r3, e4.__digit(r3) | t4.__digit(r3));
          for (; r3 < n4; r3++) _3.__setDigit(r3, e4.__digit(r3));
          for (; r3 < s3; r3++) _3.__setDigit(r3, 0);
          return _3;
          ...
          var _3 = e4.length - t4.length;
          if (0 != _3) return _3;
          for (var n4 = e4.length - 1; 0 <= n4 && e4.__digit(n4) === t4.__digit(n4); ) n4--;
          ...
          if (g3.length > l3) for (g3.__setDigit(l3++, o3 + u4); l3 < g3.length; ) g3.__setDigit(l3++, 0);
          else if (0 !== o3 + u4) throw new Error("implementation bug");
          ...
          for (var _3, n4 = 0, l3 = 2 * e4.length - 1; 0 <= l3; l3--) _3 = (n4 << 15 | e4.__halfDigit(l3)) >>> 0, n4 = 0 | _3 % t4;
          return n4;
          ...
          if (_3) return d3.__inplaceRightShift(r3), i3 ? { quotient: o3, remainder: d3 } : d3;
          if (i3) return o3;
          ...
          if (0 === t4) {
            for (var g3 = 0; g3 < l3; g3++) n4.__setDigit(g3, e4.__digit(g3));
            return 0 < _3 && n4.__setDigit(l3, 0), n4;
          }
          for (var o3, u4 = 0, s3 = 0; s3 < l3; s3++) o3 = e4.__digit(s3), n4.__setDigit(s3, 1073741823 & o3 << t4 | u4), u4 = o3 >>> 30 - t4;
          return 0 < _3 && n4.__setDigit(l3, u4), n4;
        } }, { key: "__leftShiftByAbsolute", value: function(e4, t4) {
          var _3 = a3.__toShiftAmount(t4);
          if (0 > _3) throw new RangeError("BigInt too big");
          var n4 = 0 | _3 / 30, l3 = _3 % 30, g3 = e4.length, o3 = 0 !== l3 && 0 != e4.__digit(g3 - 1) >>> 30 - l3, u4 = g3 + n4 + (o3 ? 1 : 0), s3 = new a3(u4, e4.sign);
          if (0 === l3) {
            for (var r3 = 0; r3 < n4; r3++) s3.__setDigit(r3, 0);
            for (; r3 < u4; r3++) s3.__setDigit(r3, e4.__digit(r3 - n4));
          } else {
            for (var h3 = 0, b3 = 0; b3 < n4; b3++) s3.__setDigit(b3, 0);
            for (var m3, c3 = 0; c3 < g3; c3++) m3 = e4.__digit(c3), s3.__setDigit(c3 + n4, 1073741823 & m3 << l3 | h3), h3 = m3 >>> 30 - l3;
            if (o3) s3.__setDigit(g3 + n4, h3);
            else if (0 !== h3) throw new Error("implementation bug");
          }
          return s3.__trim();
        } }, { key: "__rightShiftByAbsolute", value: function(e4, t4) {
          var _3 = e4.length, n4 = e4.sign, l3 = a3.__toShiftAmount(t4);
          if (0 > l3) return a3.__rightShiftByMaximum(n4);
          var g3 = 0 | l3 / 30, o3 = l3 % 30, u4 = _3 - g3;
          if (0 >= u4) return a3.__rightShiftByMaximum(n4);
          var s3 = false;
          if (n4) {
            if (0 != (e4.__digit(g3) & (1 << o3) - 1)) s3 = true;
            else for (var r3 = 0; r3 < g3; r3++) if (0 !== e4.__digit(r3)) {
              s3 = true;
              break;
            }
          }
          ...
          if (0 === o3) {
            ...
            for (var m3 = g3; m3 < _3; m3++) b3.__setDigit(m3 - g3, e4.__digit(m3));
          } else {
            for (var c3, v3 = e4.__digit(g3) >>> o3, y3 = _3 - g3 - 1, f3 = 0; f3 < y3; f3++) c3 = e4.__digit(f3 + g3 + 1), b3.__setDigit(f3, 1073741823 & c3 << 30 - o3 | v3), v3 = c3 >>> o3;
            b3.__setDigit(y3, v3);
          }
          ...
          if (l3) {
            var g3 = l3.call(e4);
            if ("object" !== i2(g3)) return g3;
          }
          var o3 = e4.toString;
          if (o3) {
            var u4 = o3.call(e4);
            if ("object" !== i2(u4)) return u4;
          }
          throw new TypeError("Cannot convert object to primitive value");
          ...
          for (var _3 = 0 | (e4 + 29) / 30, n4 = new a3(_3, t4.sign), l3 = _3 - 1, g3 = 0; g3 < l3; g3++) n4.__setDigit(g3, t4.__digit(g3));
          ...
          for (var n4 = Math.min, l3, g3 = 0 | (e4 + 29) / 30, o3 = new a3(g3, _3), u4 = 0, s3 = g3 - 1, d3 = 0, h3 = n4(s3, t4.length); u4 < h3; u4++) l3 = 0 - t4.__digit(u4) - d3, d3 = 1 & l3 >>> 30, o3.__setDigit(u4, 1073741823 & l3);
          for (; u4 < s3; u4++) o3.__setDigit(u4, 0 | 1073741823 & -d3);
          var b3, m3 = s3 < t4.length ? t4.__digit(s3) : 0, c3 = e4 % 30;
          if (0 === c3) b3 = 0 - m3 - d3, b3 &= 1073741823;
          else {
            var v3 = 32 - c3;
            m3 = m3 << v3 >>> v3;
            var y3 = 1 << 32 - v3;
          ...
          for (var i3 = 1; 0 < t4; ) 1 & t4 && (i3 *= e4), t4 >>>= 1, e4 *= e4;
          return i3;
...
var O2SettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  dateExtractionPatternSetting() {
    const docusaurus = this.plugin.docusaurus;
    new import_obsidian.Setting(this.containerEl).setName("Date extraction pattern").setDesc("The pattern to extract date from note title.").addDropdown((dropdown) => {
...
var DocusaurusSettings = class {
  ...
  afterPropertiesSet() {
    return this.docusaurusPath !== void 0 && this.docusaurusPath.length !== 0;
  }
};
...
var jekyllReplacer = (match, p1, p2, p3) => `${p3}
{: .prompt-${replaceKeyword(p1)}}`;
var convertCalloutSyntaxToChirpy = (content) => content.replace(ObsidianRegex.CALLOUT, jekyllReplacer);
var jekyllCalloutMap = /* @__PURE__ */ new Map();
...
var docusaurusReplacer = (match, p1, p2, p3) => {
...
var convertDocusaurusCallout = (input) => input.replace(ObsidianRegex.CALLOUT, docusaurusReplacer);
var replaceDocusaurusKeyword = (target) => docusaurusCalloutMap[target.toLowerCase()] || "note";
var docusaurusCalloutMap = {
  note: "note",
  info: "info",
  todo: "note",
  example: "note",
...
var replaceDocusaurusContents = (contents) => contents.replace(/^> /, "");
...
function ParseTemporalTimeZone(e2) {
  const { ianaName: t2, offset: r2, z: o2 } = function ParseTemporalTimeZoneString(e3) {
    if (new RegExp(`^${$.source}$`, "i").test(e3)) return { ianaName: e3 };
    try {
...
function ToTemporalDurationRecord(e2) {
  if (!IsObject(e2)) return function ParseTemporalDurationString(e3) {
    var _a, _b;
    const t3 = Q.exec(e3);
    ...
    let u2 = 0, T2 = 0, p2 = 0;
    if (void 0 !== l3) {
      if ((_b = (_a = d3 != null ? d3 : m3) != null ? _a : c3) != null ? _b : h3) throw new RangeError("only the smallest unit can be fractional");
      p2 = 3600 * ToIntegerOrInfinity((l3 + "000000000").slice(0, 9)) * r3;
    } else if (u2 = void 0 === d3 ? 0 : ToIntegerWithTruncation(d3) * r3, void 0 !== m3) {
      if (c3 != null ? c3 : h3) throw new RangeError("only the smallest unit can be fractional");
  ...
  if (IsTemporalDuration(e2)) return { years: GetSlot(e2, w), months: GetSlot(e2, D), weeks: GetSlot(e2, G), days: GetSlot(e2, v), hours: GetSlot(e2, C), minutes: GetSlot(e2, O), seconds: GetSlot(e2, b), milliseconds: GetSlot(e2, E), microseconds: GetSlot(e2, M), nanoseconds: GetSlot(e2, R) };
...
function DefaultTemporalLargestUnit(e2, t2, r2, o2, n2, a2, i2, s2, l2, d2) {
  for (const [m2, c2] of [["years", e2], ["months", t2], ["weeks", r2], ["days", o2], ["hours", n2], ["minutes", a2], ["seconds", i2], ["milliseconds", s2], ["microseconds", l2], ["nanoseconds", d2]]) if (0 !== c2) return Ae.get(m2);
  return "nanosecond";
}
...
function ToTemporalDateTime(e2, t2) {
  ...
  if (IsObject(e2)) {
    ...
    if (ToTemporalOverflow(t2), { year: r2, month: o2, day: n2, hour: a2, minute: d2, second: m2, millisecond: c2, microsecond: h2, nanosecond: u2, calendar: T2, z: i2 } = function ParseTemporalDateTimeString(e3) {
      return ParseISODateTime(e3);
    }(ToString(e2)), i2) throw new RangeError("Z designator not supported for PlainDateTime");
...
function ToTemporalTime(e2, t2 = "constrain") {
  ...
  if (IsObject(l2)) {
  ...
  } else ({ hour: r2, minute: o2, second: n2, millisecond: a2, microsecond: i2, nanosecond: s2 } = function ParseTemporalTimeString(e3) {
    const t3 = z.exec(e3);
    ...
    if (/[tT ][0-9][0-9]/.test(e3)) return { hour: r3, minute: o3, second: n3, millisecond: a3, microsecond: i3, nanosecond: s3 };
    try {
...
function ToTemporalZonedDateTime(e2, t2) {
  ...
  if (IsObject(e2)) {
    ...
    if ({ year: r2, month: o2, day: n2, hour: a2, minute: i2, second: s2, millisecond: l2, microsecond: d2, nanosecond: m2, ianaName: I3, offset: h2, z: S2, calendar: u2 } = function ParseTemporalZonedDateTimeString(e3) {
      ...
      return t3;
    }(ToString(e2)), c2 = ToTemporalTimeZoneSlotValue(I3), S2 ? y2 = "exact" : h2 || (y2 = "wall"), u2 || (u2 = "iso8601"), !IsBuiltinCalendar(u2)) throw new RangeError(`invalid calendar identifier ${u2}`);
...
function ToTemporalCalendarSlotValue(e2) {
  if (IsObject(e2)) {
    ...
    }(e2)) throw new TypeError("expected a Temporal.Calendar or object implementing the Temporal.Calendar protocol");
    return e2;
  }
...
function ToTemporalTimeZoneSlotValue(e2) {
  if (IsObject(e2)) {
    ...
    }(e2)) throw new TypeError("expected a Temporal.TimeZone or object implementing the Temporal.TimeZone protocol");
    return e2;
  }
...
function DurationSign(e2, t2, r2, o2, n2, a2, i2, s2, l2, d2) {
  for (const m2 of [e2, t2, r2, o2, n2, a2, i2, s2, l2, d2]) if (0 !== m2) return m2 < 0 ? -1 : 1;
  return 0;
}
...
function BalancePossiblyInfiniteDuration(t2, r2, o2, a2, i2, s2, l2, d2, m2) {
  ...
  for (const e2 of [I2, D2, G2, v2, C2, O2, b2]) if (!me(e2)) return 1 === w2 ? "positive overflow" : "negative overflow";
...
function DifferenceISODate(e2, t2, r2, o2, n2, a2, i2) {
  switch (i2) {
    ...
    case "month": {
      ...
      if (h2 !== s2 && (m2 -= s2, u2 += 12 * s2), c2 = AddISODate(e2, t2, r2, m2, u2, 0, 0, "constrain"), h2 = -CompareISODate(c2.year, c2.month, c2.day, o2, n2, a2), 0 === h2) return "year" === i2 ? { years: m2, months: u2, weeks: 0, days: 0 } : { years: 0, months: u2 + 12 * m2, weeks: 0, days: 0 };
...
function DifferenceZonedDateTime(t2, r2, o2, n2, a2, p2) {
  ...
  if (import_jsbi.default.equal(f2, Ie)) return { years: 0, months: 0, weeks: 0, days: 0, hours: 0, minutes: 0, seconds: 0, milliseconds: 0, microseconds: 0, nanoseconds: 0 };
...
function CompareISODate(e2, t2, r2, o2, n2, a2) {
  for (const [i2, s2] of [[e2, o2], [t2, n2], [r2, a2]]) if (i2 !== s2) return ComparisonResult(i2 - s2);
  return 0;
}
...
function DateTimeFormatImpl(e2, t2 = {}) {
  ...
  if (r2) {
    const e3 = lt({}, a2);
    for (const t3 in e3) mt(dt, o2, [t3]) || delete e3[t3];
    this[it] = e3;
  } else this[it] = o2;
...
function amend(e2 = {}, t2 = {}) {
  const r2 = lt({}, e2);
  for (const e3 of ["year", "month", "day", "hour", "minute", "second", "weekday", "dayPeriod", "timeZoneName", "dateStyle", "timeStyle"]) r2[e3] = e3 in t2 ? t2[e3] : r2[e3], false !== r2[e3] && void 0 !== r2[e3] || delete r2[e3];
  return r2;
}
...
var copyMarkdownFile = async (plugin) => {
  ...
  for (const file of markdownFiles) {
    ...
    const newPath = file.path.replace(file.name, newFileName).replace(/,+/g, "").replace(/\s/g, "-");
    await plugin.app.vault.copy(file, newPath).catch((error) => {
      console.error(error);
      new import_obsidian3.Notice("Failed to copy file, see console for more information.");
    });
  }
...
var copyFile = (sourceFilePath, targetFilePath) => {
  ...
  if (!import_fs2.default.existsSync(targetDirectory)) {
    import_fs2.default.mkdirSync(targetDirectory, { recursive: true });
  }
  import_fs2.default.copyFileSync(sourceFilePath, targetFilePath);
};
var copy = (sourceFolderPath, targetFolderPath, replacer, publishedDate) => {
  import_fs2.default.readdirSync(sourceFolderPath).filter((filename) => filename.startsWith(TEMP_PREFIX)).forEach((filename) => {
...
var transformPath = (input, replacer, date) => {
...
var convertFootnotes = (input) => input.replace(
...
var validation_default = async (plugin) => {
  const adapter = plugin.app.vault.adapter;
    ...
    this.addCommand({
      ...
      checkCallback: (checking) => {
        if (this.jekyll.afterPropertiesSet() || this.docusaurus.afterPropertiesSet()) {
          ...
          o2ConversionCommand(this).then(() => new import_obsidian7.Notice("Converted to successfully.", 5e3)).then(() => {
...
var o2ConversionCommand = async (plugin) => {
  await validation_default(plugin);
